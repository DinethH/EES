...
<br>
    ...
    <ul id="ri">
    	<li><p>2010 - 2012 "Analyzing and Modeling Chemical Penetration in Building Materials" (PI), Lawrence Livermore National Laboratory, Livermore, CA.</p></li>
		<li><p>2010 - 2013 "Integrated Experimental and Modeling Approaches to Studying the Fracture-Matrix Interaction in Gas Recovery from Barnett Shale" (PI), Research Partnership to Secure Energy for America (RPSEA), DOE's National Energy Technology Laboratory.</p></li>
		<li><p>2010 - 2013 "Effects of Pore-Scale Physics on Uranium Geochemistry in Hanford Sediments" (PI), DOE Office of Science's Subsurface Biogeochemical Research program.</p></li>
    ...
    <ul id="ri">
    		<li><p>2010 - 2012 "Three Dimensional Scanning of Uranium Distribution in Hanford Sediment Grains" (PI), Subsurface Science Scientific Focus Area, Pacific Northwest National Laboratory, Richland, WA.</p></li>

...
<meta name="author" content="Dineth Hettiarachchi, dineth@sachintha.com">
		...
		<ul id="menu">
        	...
        	<li><a href="index.php?i=news">News</a>
       		...
       		<li><a  href="index.php?i=events">Events</a>
            	<ul>
                    ...
                    <li><a target="_blank" href="http://president.ucar.edu/university-relations/uforum">UFORUM</a></li>    
            	</ul>
        	</li>
        	<li><a href="index.php?i=people&s=faculty">People</a>
                <ul>
                    ...
                    <li><a href="index.php?i=people&s=grad">Grad Students</a></li>
          		</ul>
        	</li>
        	<li><a href="index.php?i=academics&s=undergraduate">Academics</a>
                <ul>
                    ...
                    <li><a href="index.php?i=academics&s=certificates">Certificates</a></li>
                </ul>
           	</li>
        	<li><a href="index.php?i=research">Research</a></li>
        	<li><a href="?i=alumni&s=al">Alumni</a>
                    <ul>
                        
                        <li>
                            <a href="?i=alumni&s=al">EES Alumni</a>
                        </li>
                        <li>
                            <a href="?i=alumni&s=members">Members</a>
                        </li>
                    </ul>
                </li>

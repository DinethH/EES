...
<div id="wrapper" align="left">
	...
	<table class="clearfix" style="padding-left:10px;" width="1024px">
        ...
        <tr>
            ...
            <!--
                <p style="font-size:18px; padding-right:60px; text-align:justify; color:#000">&quot;A message from the Chair"  
             	</p> 
                ...
                <h6>CAREERS &amp; OPPORTUNITIES</h6>
                	<p>
                    	Have internships or career opportunities to offer? <a href="http://localhost:81/ees/index.php?i=contact" >Let us know</a>
                    </p>
                <h6>SHARE YOUR EXPERIENCES</h6>
                	<p>
                   	<a href="?i=contact">Share your experiences with us. </a></p>
            </td>
		</tr>
	</table>
<br />

...
if (isset($_POST['submitForm'])) {
	...
	if ($_POST['desiredTransportation']==1 && $bbCount >= $busCapacity)
	    $transportLimit = TRUE;
	...
	if (!$errors) {
		...
		$datePreffered = addslashes($_POST['datePreffered']);
		$prefferedTransportation = addslashes($_POST['desiredTransportation']);
		$studentID = addslashes($_POST['sID']);
		$firstName = addslashes($_POST['firstName']);
		$lastName = addslashes($_POST['lastName']);
		$labSection = addslashes($_POST['labSection']);
...
<div style="border-radius:3px; background-color:red; color:white; padding:10px; display:none;">
<table>
	<tr>
    	<td valign="top">
        	Update [09/03/2013]:
        ...
        <td valign="top">
        	Oct 12<sup>th</sup> has been changed to Oct 27<sup>th</sup><br />
			Oct 5<sup>th</sup> has been changed to TBA
        </td>
    </tr>
    <tr>
    	<td>
        ...
        <td>
        	TBA has been changed to Nov 9<sup>th</sup>
        </td>
    </tr>
</table>
</div><br />
                	...
                	<tr height="30">
						...
						?>
                            ...
                            <input name="cCount" type="hidden" value="<?php echo $cCount; ?>" />
                                ...
                                <tr height="30">
                                    ...
                                    <td width="25%">
                                    	 <div class="<?php	///////
										 					if ($bCount>=$busCapacity)
										 						echo 'availabilityDotRed';
															elseif (($bCount+$bCountP)>=$busCapacity)
                                      ...
                                      "><span title="<?php									  	
										...
										elseif ($busCapacity-$bCount-$bCountP < 0)
											echo 'Overbooked';
										else 
											echo 'Number of available seats: '.($busCapacity-$bCount-$bCountP).''; ?>">
										<?php 
											if ($bCount>=$busCapacity) { 
												echo $busCapacity-$bCount-$bCountP;
											}
											elseif (($bCount+$bCountP)>=$busCapacity) 
												echo $bCountP.'P'; 
											else {
						...
						?>
                               ...
                               <tr height="30">
                                ...
                                <tr height="30">
                                	<td colspan="1">
                                    	<div class="availabilityDotYellow"></div>
                                    </td>
                                    <td colspan="3">
                                    	Unavailable; pending for confirmation
                                    </td>
                                </tr>
                                <tr height="30">
                                	<td colspan="1">
                                    	<div class="availabilityDotRed"></div>
                                    </td>
                                    <td colspan="3">
                                    	Unavailable
                                    </td>

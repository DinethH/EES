...
if (($row['hourUpdated'] != $currentHour) || (($row['hourUpdated']) == $currentHour) && (($currentMinute - $row['minuteUpdated'])>=15)) {
	...
	$update = mysql_query("UPDATE weather SET hourUpdated='$currentHour', minuteUpdated='$currentMinute', dateTimeUpdated=NOW(), temperature='$tempF', weather='$weather', fileName='$iconPng' WHERE ID=0");
}
...
?>
        	...
        	<table>
            	<tr>
                	<td valign="middle">
                    	 <img width="32" src="images/weather/<?php echo $iconName; ?>" alt="weather" />
                    </td>
                    <td valign="middle">
                    	Arlington, TX<br>
